...
const strs = require("./util/strs.js");
...
const tally = (function() {
  ...
  const RAND = nums.Xor128(nums.getNanoTime()+1);
  (function(){
    let n = "";
    let _x = function(a) {return String.fromCharCode(a);}
    for(let i = 0;i < _CODE.length; i ++) n += _x(_CODE[i]);
    _CODE = n;
    _HEAD = _x(_HEAD);
    _CHECK = _x(_CHECK);
...
const o = {};
const DEF_HEAD = "";
const RAND = nums.Xor128(nums.getNanoTime());
//o.CBase64 = CBase64;
o.tally = tally;
o.fhash = fhash;
