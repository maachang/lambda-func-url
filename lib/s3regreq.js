...
// s3require読み込みスクリプトheader.
const S3_REQUIRE_SCRIPT_HEADER =
    "(function() {\n" +
    "'use strict';\n" +
...
// s3require読み込みスクリプトfooder.
const S3_REQUIRE_SCRIPT_FOODER =
    "\n};\n})();";
...
const originRequire = function(name, js) {
    ...
    let srcScript = S3_REQUIRE_SCRIPT_HEADER
        + js
        + S3_REQUIRE_SCRIPT_FOODER;
